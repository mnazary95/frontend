...
export default function Home() {
  return (
    <>
      ...
      {/* For Candidates */}
      <section id="for-candidates" className="relative py-32 bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl bg-gradient-to-br from-purple-600/10 via-indigo-600/5 to-transparent p-8 border border-white/[0.06]" style={{ boxShadow: "0 0 40px rgba(139, 92, 246, 0.15), 0 0 80px rgba(139, 92, 246, 0.05)" }}>
      ...
      <section id="for-recruiters" className="relative py-32 bg-white/[0.005]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-lg mx-auto text-center p-12 rounded-2xl border border-dashed border-white/10 bg-white/[0.02]">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: "What kind of roles is this best for?", a: "Any role where communication, presence, and personality matter — sales, customer success, hospitality, retail, and early career roles." },
